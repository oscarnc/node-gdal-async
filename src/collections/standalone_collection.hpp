#ifndef __NODE_GDAL_STANDALONE_COLLECTION_H__
#define __NODE_GDAL_STANDALONE_COLLECTION_H__
...
class StandaloneCollection : public Nan::ObjectWrap {
    public:
  static constexpr const char *_className = "StandaloneCollection<abstract>";
  ...
  static NAN_METHOD(New) {
    ...
    if (info[0]->IsExternal()) {
      ...
      Nan::ThrowError("Cannot create StandaloneCollection directly");
      return;
    }
  }

  static Local<Value> New(Local<Value> parent) {
  ...
  GDAL_ASYNCABLE_TEMPLATE(get) {
    ...
    GDALAsyncableJob<GDALOBJ> job(0);
    ...
    job.rval = [](GDALOBJ r, GetFromPersistentFunc) { return NODEOBJ::New(r, false); };
  ...
  StandaloneCollection() : Nan::ObjectWrap() {
  }
